...
const sinsombrero = [
  {
    ...
    iniciales: "MM",
    color: "#e4572e",
    imagen: "assets/maruja/retrato.jpg",
    ...
    obras: ["Serie Verbenas y Estampas (1927–1928)", "Cloacas y campanarios (1929–1932)", "Antro de fósiles (1930)", "Espantapájaros (1930)", "Arquitecturas minerales y vegetales (1933–1935)", "La religión del trabajo (1936–1939)", "La sorpresa del trigo (1936)", "Naturalezas vivas (1941–1944)", "Cabezas bidimensionales y Máscaras (1940s–1950s)", "Moradores del vacío (1968–1980)", "Retrato de Concha Méndez (Mujer en bicicleta, 1927)"],
    ...
    bioParrafos: [
      "Nacida en Viveiro (Lugo) el 5 de enero de 1902 en el seno de una familia numerosa, en 1913 se trasladó con los suyos a Avilés, donde empezó a formarse en la Escuela de Artes y Oficios. En 1922 llegó a un Madrid en plena efervescencia cultural y estudió Bellas Artes en la Real Academia de San Fernando (1922–1926) junto a su hermano, el escultor Cristino Mallo, compartiendo aulas con Salvador Dalí, quien la introdujo en el círculo de la Residencia de Estudiantes. Con la complicidad de sus hermanos y aprovechando la débil salud de su madre, Maruja pudo salir de noche y vivir con libertad su juventud, deambulando por el Madrid nocturno junto a Dalí, Lorca y Luis Buñuel. Entre 1928 y 1936 desarrolló sus series de <em>Estampas</em> —populares, deportivas, de máquinas y maniquíes, cinemáticas—, una declaración estética que enlazaba la modernidad de su época con la tradición popular española.",
      "Su obra se ordena en rigurosas series temáticas que recorren más de cinco décadas. Tras las jubilosas <em>Verbenas</em> y <em>Estampas</em> (1927–1928) —presentadas en 1928 en los salones de la <em>Revista de Occidente</em> por invitación de Ortega y Gasset, un acontecimiento que la situó en primera línea de la vanguardia—, dio un giro radical hacia lo siniestro con <em>Cloacas y campanarios</em> (1929–1932), de atmósferas apocalípticas a la que pertenecen <em>Antro de fósiles</em> (1930) y <em>Espantapájaros</em> (1930). En 1932, becada por la Junta de Ampliación de Estudios, viajó a París, expuso en la Galerie Pierre y allí André Breton compró <em>Espantapájaros</em>; conoció además a Miró, Picasso, De Chirico y Magritte. De su afán por fusionar lo orgánico con lo geométrico nacieron <em>Arquitecturas minerales y vegetales</em> y <em>Construcciones rurales</em> (1933–1935), en sintonía con la Escuela de Vallecas de Alberto Sánchez y Benjamín Palencia.",
      "En esos años trabó una estrecha amistad con la filósofa María Zambrano y con el poeta chileno Pablo Neruda, cónsul en Madrid, con quien recorría los barrios populares en busca de materiales que después aparecerían en sus cuadros. Vivió una intensa relación con Rafael Alberti —que le dedicó el poema <em>La primera ascensión de Maruja Mallo al subsuelo</em>— y colaboró con él en decorados como <em>Santa Casilda</em> y <em>La pájara pinta</em>. Dalí la definió como «mitad marisco, mitad ángel» y Lorca elogió que sus cuadros estaban pintados «con más imaginación, emoción y sensualidad». A su regreso de París, comprometida con la República, conoció a Miguel Hernández, con quien mantuvo una relación que inspiró los poemas de <em>Imagen de tu huella</em>, incluidos en <em>El rayo que no cesa</em>. Su serie <em>La religión del trabajo</em> (1936–1939), de grandes figuras femeninas monumentales en plata y dorado, homenajea al mundo del mar y del campo.",
      "La Guerra Civil la sorprendió participando en las Misiones Pedagógicas en Galicia; pasó a Portugal y, por mediación de la poeta Gabriela Mistral —entonces embajadora de Chile en Lisboa—, logró embarcar hacia Buenos Aires en 1937. Su exilio americano de unos veinticinco años la llevó por Argentina, Uruguay, Brasil, Chile y Estados Unidos, y en él desarrolló las <em>Naturalezas vivas</em> (1941–1944) y las series <em>Cabezas bidimensionales</em> y <em>Máscaras</em>. Regresó a España a comienzos de los años sesenta y, pese a un largo olvido, retomó su trabajo con la serie futurista <em>Moradores del vacío</em> (1968–1980). En 1982 participó en la primera edición de ARCO y recibió la Medalla de Oro al Mérito en las Bellas Artes; después llegarían la Medalla de Oro de la Comunidad de Madrid (1990) y la de la Xunta de Galicia (1991). Murió en Madrid el 6 de febrero de 1995, a los 93 años. En 2025, treinta años después, el Centro Botín y el Museo Reina Sofía le dedicaron la gran retrospectiva <em>Máscara y compás</em>."
    ],
    datos: {
      "Formación": "Escuela de Artes y Oficios de Avilés · Real Academia de San Fernando (1922–1926)",
      "Círculo": "Dalí, Lorca, Buñuel, Alberti · amistad con María Zambrano y Pablo Neruda · Escuela de Vallecas",
      "Series destacadas": "Verbenas y Estampas · Cloacas y campanarios · La religión del trabajo · Naturalezas vivas",
      "Episodio": "Protagonista, con Margarita Manso, del gesto del sombrero en la Puerta del Sol",
      "Exilio": "Buenos Aires, Uruguay, Brasil, Chile y EE. UU. (1937 – comienzos de los años 60)",
      "Reconocimientos": "Medalla de Oro al Mérito en las Bellas Artes (1982) · Comunidad de Madrid (1990) · Xunta de Galicia (1991)"
    },
    galeria: [
      { src: "assets/maruja/la-verbena-1927.jpg", titulo: "La verbena (1927), serie Verbenas — Museo Reina Sofía" },
      { src: "assets/maruja/el-mago-pim-pam-pum-1926.jpg", titulo: "El mago / Pim Pam Pum (1926) — Art Institute of Chicago" },
      { src: "assets/maruja/kermesse-1928.jpg", titulo: "Kermesse (1928) — Colección Pompidou" },
      { src: "assets/maruja/antro-de-fosiles-1930.jpg", titulo: "Antro de fósiles (1930), serie Cloacas y campanarios — Museo Reina Sofía" },
      { src: "assets/maruja/espantapajaros-1930.jpg", titulo: "Espantapájaros (1930), comprado por André Breton" },
      { src: "assets/maruja/sorpresa-del-trigo-1936.jpg", titulo: "Sorpresa del trigo (1936), serie La religión del trabajo" },
      { src: "assets/maruja/canto-de-las-espigas-1939.jpg", titulo: "Canto de las espigas (1939), serie La religión del trabajo — Museo Reina Sofía" },
      { src: "assets/maruja/naturaleza-viva-1941.jpg", titulo: "Naturaleza viva (c. 1941) — Malba, Buenos Aires" }
    ],
    fuentes: [
      ...
      { label: "Tal día como hoy: «Maruja Mallo (1902-1995)» (Diana Larrea)", href: "https://www.taldiacomohoy.es/post/maruja-mallo-1902-1995" },
      { label: "Universo Lorca: «Mallo, Maruja (Ana María Gómez González)»", href: "https://www.universolorca.com/personaje/mallo-maruja-ana-maria-gomez-gonzalez/" },
